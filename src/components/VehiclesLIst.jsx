...
//         <Link to={`/details/${vehicle.uid}`} className="btn" style={{ fontSize: "14px", marginTop: "5px", marginRight: "0", marginLeft: "55px", marginBottom: "0", backgroundColor: "#ffe81f" }}>Learn more!</Link>
//     </div>
// );
